export class RioDeJaneiroService {

  private readonly TAMANHO_IE = 8;
  private readonly TAMANHO_NUMERO = 7;
  private readonly TAMANHO_DIGITOS = 1;

  private readonly PESOS_DIGITO_UM = [2, 7, 6, 5, 4, 3, 2];

  /**
   * Regra de validação aplicada: http://www.sintegra.gov.br/Cad_Estados/cad_RJ.html
   *
