export class RondoniaService {

  private readonly TAMANHO_IE = 14;
  private readonly TAMANHO_NUMERO = 13;
  private readonly TAMANHO_DIGITOS = 1;

  private readonly PESOS_DIGITO_UM = [6, 5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2];

  /**
   * Regra de validação aplicada: http://www.sintegra.gov.br/Cad_Estados/cad_RO.html
   *
