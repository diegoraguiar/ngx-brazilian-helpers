export class ParanaService {

  private readonly TAMANHO_IE = 10;
  private readonly TAMANHO_NUMERO = 8;
  private readonly TAMANHO_DIGITOS = 2;

  private readonly PESOS_DIGITO_UM = [3, 2, 7, 6, 5, 4, 3, 2];
  private readonly PESOS_DIGITO_DOIS = [4, 3, 2, 7, 6, 5, 4, 3, 2];

  /**
   * Regra de validação aplicada: http://www.sintegra.gov.br/Cad_Estados/cad_PR.html
   *
